...
namespace CursoWindowsFormsBiblioteca.Classes
{
    public class Cliente
    {
        public class Unit
        {
            ...
            //public List<string> ListaFicharioSQLServer(string Conexao)
            //{
            ...
            public Unit BuscarFicharioSQLREL(string Id)
            {
                try
                {
                    ...
                    {
                        db.Close();
                        throw new Exception("Identificador inexistente: " + Id);
                    }
                    else
                    {
        ...
        // Método para transformar o Json em Classe
        public static Unit DesSerializedClassUnit(string vJson)
        {
            return JsonConvert.DeserializeObject<Unit>(vJson);
        }

        // método para transformar a classe em Json
