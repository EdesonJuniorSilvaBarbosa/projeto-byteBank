...
using System.IO; // referencia que traz para o codigo propriedades para manipular diretorios pastas e etc.
    ...
    public class Fichario
    {
        ...
        public void Incluir(string Id, string jsonUnit)
        {
            ...
            try
            {
                ...
                {
                    status = false;
                    mensagem = "Inclusão não permitda porque o identificador já existe: " + Id;
                }
                else
                {
        ...
        public void Alterar(string Id, string jsonUnit)
        {
            ...
            try
            {
                ...
                {
                    status = false;
                    mensagem = "Alteração não permitda porque o identificador já existe: " + Id;
                }
                else
                {
                    File.Delete(diretorio + "\\" + Id + ".json");
